...
class BiEncoder(LightningModule):
    ...
    def training_step(self, batch, batch_idx) -> float:
        ...
        pos_scores = self.scoring_function(Q_emb, D_pos_emb)

        # HARD NEGATIVES =======================================================
        # Compute hard negative scores -----------------------------------------
        neg_scores = self.scoring_function(Q_emb, D_neg_emb)
    ...
    def validation_step(self, batch, batch_idx) -> float:
        ...
        # Compute scores -------------------------------------------------------
        scores = self.listwise_scoring_function(Q_emb, D_emb)
    ...
    def compute_scores_for_precomputed_embeddings(
        self, Q_emb: Tensor, D_emb: Tensor,
    ) -> Tensor:
        # Compute scores -------------------------------------------------------
